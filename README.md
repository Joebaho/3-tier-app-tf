...
## 🚀 Overview:
This project will help us deploy a scalable and resilient multi-tier architecture on Amazon Web Services (AWS) using Terraform. We will set up Terraform configuration files that will create different and necessary resources in the AWS infrastructure components. The main resources include:
